import numpy as np  
import sys,os  
caffe_root = '/media/chenyuxuan/M/chenyuxuan/caffe-ssd/'
sys.path.insert(0, caffe_root + 'python')  
import caffe  

train_proto = '/media/chenyuxuan/M/chenyuxuan/caffe-ssd/examples/MobileNetSSD_train.prototxt'  
train_model = '/media/chenyuxuan/M/chenyuxuan/caffe-ssd/examples/mobilenet_iter_8647.caffemodel'  #should be your snapshot caffemodel

deploy_proto = '/media/chenyuxuan/M/chenyuxuan/caffe-ssd/examples/MobileNetSSD_deploy.prototxt'  
save_model = '/media/chenyuxuan/M/chenyuxuan/caffe-ssd/examples/model/MobileNetSSD_deploy8647.caffemodel'
